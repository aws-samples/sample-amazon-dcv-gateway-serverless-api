...
# https://github.com/aws-samples/dcv-samples/blob/main/session-resolver/resolver.py
...
# sessionId + transport + clientIpAddress
...
def handler(event, context):
    ...
    if transport not in ["HTTP", "QUIC"]:
        print("Invalid transport parameter: " + transport)
        return {
            'statusCode': 400,
